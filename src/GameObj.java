...
//        clip();
    ...
    public boolean intersects(Rectangle col) {
        return (this.px + this.width >= col.x
            && this.py + this.height >= col.y
...
//    }
    ...
    /**
     * Subclass overrides this method based on how the object benefits the player
     */
    public abstract void changeState(Cat c); 
}